...
from api.controller.auth_controller import create_user, get_current_user, login_user, logout_user, protect_user
...
@auth_router.get("/me")
def get_authenticated_user(request:Request,user_collection:Collection = Depends(get_user_collection)):
