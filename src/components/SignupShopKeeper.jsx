      ...
      <div className="main">
          ...
          <div className="container">
              ...
              <form action="/">
                  ...
                  <div><label htmlFor="shop_name"><i className="zmdi zmdi-shopping-cart"></i>Shop Name</label></div>
                  ...
                  <div><label htmlFor="address1"><i className="zmdi zmdi-pin"></i>Address</label></div>
                  <div><input type="text" name="address1" id="address1" placeholder="1, XYZ Complex" /></div>

                  {/* <div><label htmlFor="area"><i className="zmdi zmdi-email"></i>Area</label></div> */}
